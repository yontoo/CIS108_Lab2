...
int main()
{
	...
	//Create the double temp and prompt the user to input the current temperature, and write it into the variable "temp"
	double temp = 0.0;
	cout << "Please enter the current temperature in Fahrenheit: ";
	cin >> temp;

	//Create the double temp_c and use the expression to convert the inputed temperature to Celsius, then output the converted temperature.
